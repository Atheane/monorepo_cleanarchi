...
export const testConfiguration: IAppConfiguration = {
  ...
  algoanConfig: {
    ...
    longPolling: { interval: 1500, maxAttemps: 3 },
  ...
  budgetInsightConfiguration: {
    ...
    longPolling: { interval: 2000, maxAttemps: 4 }, // if you need to renew fixtures with transactions => interval : 1000, maxAttemps : 10
  },

...
import { DiligencesType, PaymentIdentifier, UncappingState, WriteService } from '@oney/payment-core';
...
nockBack.fixtures = path.resolve(`${__dirname}/fixtures/smoneyDebts`);
...
describe('Debts api testing', () => {
  ...
  it('should sync account debts', async () => {
    ...
    await request(app)
      .post('/payment/account/zCDOH_UvV/debts')

...
export class ProjectInfo {
  ...
  getDependenciesAreBuilt(context = this.context, dependencies = this.getDependencies()) {
    if (this.dependenciesAreBuilt === undefined) {
      this.dependenciesAreBuilt = checkDependentProjectsHaveBeenBuilt(context as any, dependencies);
    }
  ...
  updateBuildableProjectPackageJsonDependencies(
    ...
    updateBuildableProjectPackageJsonDependencies(context as any, target, dependencies);
